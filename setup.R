...
# (An aside about my philosopy about namespaces in R: I like to load libraries normally
#  using librar() AND refer to them by their::namespace() I think the slight performance
#  hit is worth the additional clarity and reduced risk of namespace conflict.
# This is also the recomended method for package development)
